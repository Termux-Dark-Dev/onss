                                ...
                                <form method="post">
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $row) {               ?>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputPassword1" class="form-label">UPI Account Details</label>
                                                <input type="text" class="form-control" name="upiacc" value="<?php echo $row->acc_detail; ?>" required='true' maxlength='10' readonly>
                                            </div>
