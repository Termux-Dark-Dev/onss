...
{               ?>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label me-2">View Old File: </label>
                                   <a href="folder/<?php echo $row->File;?>" width="100" height="100" target="_blank"> <strong style="color: red">View Old File</strong></a>
